...
import com.dealmigo.ListBookmarkFragment.BookmarkListener;

public class MainActivity extends FragmentActivity implements BookmarkListener{
        ...
        public void onChangeBookmark(String bookmark) {
                ...
                ViewBookmarkFragment f = (ViewBookmarkFragment) getSupportFragmentManager().findFragmentById(R.id.rightpane);
